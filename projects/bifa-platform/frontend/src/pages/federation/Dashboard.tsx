...
export default function FederationDashboard() {
  ...
  return (
    <DashboardLayout allowedRoles={['federationOfficial']}>
      <div className="space-y-6 animate-fade-in">
        <div>
          <h1 className="font-heading text-3xl font-bold">{t('dashboard.welcome')}</h1>
          <p className="text-muted-foreground">Federation Official Portal</p>
        </div>
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between pb-2">
              <CardTitle className="text-sm font-medium text-muted-foreground">Registered Officials</CardTitle>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between pb-2">
              <CardTitle className="text-sm font-medium text-muted-foreground">Season Reports</CardTitle>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">Club regulations</p>
            </CardContent>
          </Card>
        </div>
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-muted-foreground">
              Access comprehensive reports, oversight tools, and federation statistics from this portal.
            </p>
          </CardContent>
        </Card>
      </div>
